...
public class ExtractWorld extends ExtractBase
{
    ...
    private void f0Conversion(String input_file_name, String output_file_name)
    {
        Process p;
    ...
    private void spectrumConversion(String input_file_name, String output_file_name)
    {
        Process p;
